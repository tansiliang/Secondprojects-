...
<head>
    ...
    <link rel="stylesheet" href="<?php echo (HOME_CSS_URL); ?>classify.css" type="text/css" />
    ...
    <div id="content" class="navbar-absolute">
        ...
        <div id="right" class="tab-content">
            <div class="tab-pane fade active in" id="classify">
                    <img src="<?php echo (HOME_IMG_URL); ?>classify/classfiy_2.png" width="100%" height="auto" />
            ...
            <div class="tab-pane fade" id="market">
                    <img src="<?php echo (HOME_IMG_URL); ?>classify/classfiy_1.png" width="100%" height="auto" />
                    <p class="remen"><strong>热门分类</strong></p>
                    <div id="classify_content">
                            <dvi class="thumbnail classify_content_a">
                                <a class="" href="">
            ...
            <div class="tab-pane fade" id="brand">
                    <img src="<?php echo (HOME_IMG_URL); ?>classify/classfiy_3.png" width="100%" height="auto" />
                    <p class="remen"><strong>热门分类</strong></p>
                    <div id="classify_content">
                            <dvi class="thumbnail classify_content_a">
                                <a class="" href="">
            ...
            <div class="tab-pane fade" id="luxury">
                    <img src="<?php echo (HOME_IMG_URL); ?>classify/classfiy_4.png" width="100%" height="auto" />
                    <p class="remen"><strong>热门分类</strong></p>
                    <div id="classify_content">
                            <dvi class="thumbnail classify_content_a">
                                <a class="" href="">
    ...
    <div id="footer">
            <div class="container-fluid navbar-fixed-bottom footer_div">
                <ul class="nav nav-pills">
                        ...
                        <li class="footer_li" onclick="get(1)"><a href="<?php echo (__URL__); ?>/classify.html" class="glyphicon glyphicon-share"><br/>分类</a></li>
